...
public enum Pokemon {
    ...
    STARYU("Staryu", PokemonType.WATER, PokemonType.PSYCHIC, 60, 75, 85, 100, 115),
    STARMIE("Starmie", PokemonType.PSYCHIC, PokemonType.NONE, 40, 45, 65, 100, 90),
    MR_MIME("Mr.Mime", PokemonType.PSYCHIC, PokemonType.NONE, 40, 45, 65, 100, 90),
    SCYTHER("Scyther", PokemonType.FLYING, PokemonType.BUG, 70, 110, 80, 55, 105),
    JYNX("Jynx", PokemonType.ICE, PokemonType.PSYCHIC, 65, 50, 35, 95, 95),
    ELECTABUZZ("Electabuzz", PokemonType.ELECTRIC, PokemonType.NONE, 65, 83, 57, 85, 105),
    MAGMAR("Magmar", PokemonType.FIRE, PokemonType.NONE, 65, 95, 57, 85, 93),
    PINSIR("Pinsir", PokemonType.BUG, PokemonType.NONE, 65, 125, 100, 55, 85),
    TAUROS("Tauros", PokemonType.NORMAL, PokemonType.NONE, 75, 100, 95, 70, 110),
    MAGIKARP("Magikarp", PokemonType.WATER, PokemonType.NONE, 20, 10, 55, 20, 80),
    GYARADOS("Gyarados", PokemonType.FLYING, PokemonType.WATER, 95, 125, 79, 100, 81),
    LAPRAS("Lapras", PokemonType.WATER, PokemonType.ICE, 130, 85, 80, 95, 60),
    DITTO("Ditto", PokemonType.NORMAL, PokemonType.NONE, 48, 48, 48, 48, 48),
    EEVEE("Eevee", PokemonType.NORMAL, PokemonType.NONE, 55, 55, 50, 65, 55),
    VAPOREON("Vaporeon", PokemonType.WATER, PokemonType.NONE, 130, 65, 60, 110, 65),
    JOLTEON("Jolteon", PokemonType.ELECTRIC, PokemonType.NONE, 65, 65, 60, 110, 130),
    FLAREON("Flareon", PokemonType.FIRE, PokemonType.NONE, 65, 30, 60, 110, 65),
    PORYGON("Porygon", PokemonType.NORMAL, PokemonType.NONE, 65, 60, 70, 75, 40),
    OMANYTE("Omanyte", PokemonType.WATER, PokemonType.ROCK, 35, 40, 100, 90, 35),
    OMASTAR("Omastar", PokemonType.WATER, PokemonType.ROCK, 70, 60, 125, 115, 55),
    KABUTO("Kabuto", PokemonType.WATER, PokemonType.ROCK, 30, 80, 90, 45, 55),
    KABUTOPS("Kabutops", PokemonType.WATER, PokemonType.ROCK, 60, 115, 105, 70, 80),
    AERODACTYL("Aerodactyl", PokemonType.WATER, PokemonType.ROCK, 80, 105, 65, 60, 130),
    SNORLAX("Snorlax", PokemonType.NORMAL, PokemonType.NONE, 160, 110, 65, 65, 30),
    ARTICUNO("Articuno", PokemonType.FLYING, PokemonType.ICE, 90, 85, 100, 125, 85),
    ZAPDOS("Zapdos", PokemonType.FLYING, PokemonType.ELECTRIC, 90, 90, 85, 125, 100),
    MOLTRES("Moltres", PokemonType.FIRE, PokemonType.FLYING, 90, 100, 90, 125, 90),
    DRATINI("Dratini", PokemonType.DRAGON, PokemonType.NONE, 41, 64, 45, 50, 50),
    DRAGONAIR("Dragonair", PokemonType.DRAGON, PokemonType.NONE, 61, 84, 65, 70, 70),
    DRAGONITE("Dragonite", PokemonType.DRAGON, PokemonType.FLYING, 91, 134, 95, 100, 80),
    MEWTWO("Mewtwo", PokemonType.PSYCHIC, PokemonType.NONE, 106, 110, 90, 154, 130),
    MEW("Mew", PokemonType.PSYCHIC, PokemonType.NONE, 100, 100, 100, 100, 100);
